              ...
              onPressed: () async {
                if (changed) {
                  await FirestoreService()
                      .updateData(path: FirestorePath.lesson(lesson.id), data: {
                    'startTime': lesson.startTime.millisecondsSinceEpoch,
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            trailing: TextButton(
              child: Text(
                  DateFormat('EE, MMM d, h:mm a').format(lesson.startTime)),
              onPressed: () async {
                ...
                if (newTime != null) {
                  ...
                  setState(() {
                    lesson =
                        lesson.copyWith(startTime: startTime, endTime: endTime);
                    changed = true;
                  });
                }
              },
